...
import 'package:online_shop/domain/order/entities/order.dart';
import 'package:online_shop/presentation/settings/pages/order_items.dart';
...
class OrderDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: BasicAppbar(
          title: Text('Memesan #${orderEntity.code}'),
        ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      '${orderEntity.products.length} Barang',
